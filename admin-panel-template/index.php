        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="d-flex flex-column justify-content-center align-content-center">
                    <a href="./pages/posts/index.php" class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2">
                        <span class="fw-bold fs-3 m-auto mb-5 mt-5">
                                مقالات 
                        </span>
                    </a>
                    <a href="./pages/categories/index.php" class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2">
                        <span class="fw-bold fs-3 m-auto mb-5">
                                دسته بندی ها  
                        </span>
                    </a>
                    <a href="./pages/comments/index.php" class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2">
                        <span class="fw-bold fs-3 m-auto mb-5">
                                کامنت ها  
                        </span>
                    </a>
